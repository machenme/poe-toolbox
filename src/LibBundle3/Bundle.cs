...
public class Bundle : IDisposable {
	...
	public Bundle(string filePath, BundleRecord? record = null, bool readOnly = false) :
		this(File.Open(Utils.ExpandPath(filePath), FileMode.Open, readOnly ? FileAccess.Read : FileAccess.ReadWrite, FileShare.ReadWrite), false, record) { }
